package co.kr.test04_oracle_board;
...
import co.kr.test04_oracle_board.dto.BoardDTO;
...
public class BoardController {
	...
	public String writeForm() {
		return "/board/writeForm";//writeForm.jsp 뷰 리턴
	}
...
//		}
	...
	public String replyView(Model model,HttpServletRequest request) {
		...
		return "/board/replyView";//replyView.jsp 뷰리턴
	}
...
//	}
	...
	public String replyPro(@ModelAttribute("boardDTO") BoardDTO boardDTO,
		...
		map.put("bStep", bStep);
		sqlSession.update("board.replyShape",map); //답글 위치 확보하려고 ,메서드 호출 
